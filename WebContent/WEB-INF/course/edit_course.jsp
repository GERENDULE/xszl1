        ...
        <div class="layui-row">
         <div class="layui-col-md6">
            <div class="layui-card">
                ...
                <div class="layui-card-header">编辑课程</div>
                  <span class="msg" style="color:red;">${requestScope.msg}</span>
                <form class="layui-form layui-card-body" action="CourseServlet?action=update" method="post">
              
			    
                  <div class="layui-form-item">
                    <label class="layui-form-label">课程编号：</label>
                    <div class="layui-input-block">
                      <input type="text" id="cno" name="cno" value="${course.cno }" placeholder="请输入课程编号" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <input type="text" id="cname" name="cname" value="${course.cname }" placeholder="请输入课程名称" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                    ...
                    <div class="layui-input-block">
                      <input type="text" id="tname" name="tname" value="${course.tname }" placeholder="请输入教师姓名" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                  ...
                  <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                      <textarea name="place" id="place" placeholder="请输入授课地点" class="layui-textarea">${course.place }</textarea>
                    </div>
                  </div>
